...
import { Bell, Search, Menu, Moon, Sun, User, Book, FileText, ExternalLink, Clock } from "lucide-react"
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
                    ...
                    <div
                      className={cn(
                        ...
                        isSelected 
                          ...
                          : "text-black-700 dark:text-black-300 hover:text-green-600 dark:hover:text-green-400"
                      )}
                    >
          ...
          <div className="flex items-center gap-3">
            ...
            <motion.div whileTap={{ scale: 0.9 }}>
              <Button 
                ...
                size="icon" 
                onClick={toggleTheme}
                className="h-9 w-9 text-black-500 dark:text-black-400 hover:text-black-700 dark:hover:text-black-300 relative overflow-hidden"
              >
              ...
              >
                ...
                >
                  <Button
                    ...
                    size="icon"
                    className={cn(
                      "relative h-9 w-9 text-black-500 dark:text-black-400 hover:text-emerald-600 dark:hover:text-emerald-400",
                      ...
                      {isSearching ? (
                                ...
                                {category.results.map((result, idx) => (
                                  ...
                                  >
                                    ...
                                    <div className="flex-1 min-w-0">
                                      <p className="text-sm font-medium truncate text-black-800 dark:text-black-200">{result.title}</p>
                                      {result.subtitle && (
                        ...
                        <div>
                          <div className="flex items-center justify-between px-3 py-1.5">
                            <div className="flex items-center gap-2 text-xs font-medium text-black-500 dark:text-black-400 uppercase">
                            ...
                            <motion.button 
                              ...
                              className="text-xs text-black-500 dark:text-black-400 hover:text-red-500 dark:hover:text-red-400 transition-colors"
                            >
                              Очистить
                            </motion.button>
                          </div>
                          <div className="mt-1">
                            {recentSearches.map((query, idx) => (
                              ...
                              >
                                ...
                                <span className="text-sm text-black-800 dark:text-black-200">{query}</span>
                              </motion.div>
                            ))}
                          </div>
                        </div>
            ...
            <DropdownMenu>
                ...
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                  <Button variant="ghost" size="icon" className="relative h-9 w-9">
                    ...
                    <motion.span 
                      ...
                      className="absolute top-1 right-1 h-2 w-2 rounded-full bg-emerald-500 ring-2 ring-white dark:ring-gray-800"
                    ></motion.span>
                  </Button>
                </motion.div>
              </DropdownMenuTrigger>
              <DropdownMenuContent align="end" className="w-64 p-2 rounded-xl backdrop-blur-sm bg-white/95 dark:bg-gray-800/95 border border-gray-200 dark:border-gray-700">
                ...
                <div className="max-h-[300px] overflow-auto py-1">
                  ...
                  >
                    <DropdownMenuItem className="py-2 px-3 rounded-lg hover:bg-emerald-50 dark:hover:bg-emerald-900/20">
                          ...
                          <div
                            className={cn(
                              ...
                              isSelected
                                ...
                                : "hover:bg-emerald-50/80 dark:hover:bg-emerald-900/30 text-black-700 dark:text-black-300"
                            )}
