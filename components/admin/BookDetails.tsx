    ...
    <div className="min-h-screen relative">
      ...
      <div className="container mx-auto p-6 relative z-10">
        ...
        <FadeInView delay={0.2}>
          <motion.div
            className="backdrop-blur-xl bg-emerald-500/10 dark:bg-emerald-900/20 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-emerald-500/20 dark:border-emerald-700/30"
            whileHover={{
              y: -5,
          ...
          >
            ...
            <div className="mt-8">
              <Tabs defaultValue="details" onValueChange={setActiveTab}>
                ...
                <TabsContent value="details" className="mt-6">
                  ...
                  <motion.div
                    className="mt-6 backdrop-blur-xl bg-emerald-500/10 dark:bg-emerald-900/20 rounded-xl p-4 border border-emerald-500/20 dark:border-emerald-700/30 shadow-sm"
                    whileHover={{
                      y: -3,
                      boxShadow: "0 10px 25px -5px rgba(0, 0, 0, 0.1), 0 8px 10px -6px rgba(0, 0, 0, 0.05)",
                    }}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                    ...
                    {book.dateModified && (
                      <InfoField
                        ...
                        value={new Date(book.dateModified).toLocaleDateString()}
                        icon={<Clock className="w-4 h-4" />}
                      />
                    )}
                  </div>
            ...
            <div className="flex gap-4 justify-end mt-8">
              <Link href={`/admin/books/${book.id}/update`}>
                <motion.button
                  className="bg-emerald-600/90 hover:bg-emerald-700/90 text-white font-medium rounded-lg px-6 py-2.5 flex items-center gap-2 shadow-md backdrop-blur-md"
                  whileHover={{
                    y: -3,
                    boxShadow: "0 10px 25px -5px rgba(0, 0, 0, 0.1), 0 8px 10px -6px rgba(0, 0, 0, 0.05)",
                  }}
              ...
              <Link href="/admin/books">
                <motion.button
                  className="bg-green-500/90 hover:bg-green-600/90 text-white font-medium rounded-lg px-6 py-2.5 flex items-center gap-2 shadow-md backdrop-blur-md"
                  whileHover={{
                    y: -3,
                    boxShadow: "0 10px 25px -5px rgba(0, 0, 0, 0.1), 0 8px 10px -6px rgba(0, 0, 0, 0.05)",
                  }}
