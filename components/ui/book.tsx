...
export function Book(props: BookProps) {
  ...
  return (
    ...
    >
      <div className="contain-inline-size aspect-[49/60] w-fit rotate-0 relative [transform-style:preserve-3d] min-w-[calc(var(--book-width))] transition-transform duration-1000 ease-out group-hover:[transform:rotateY(-20deg)_scale(1.066)translateX(-8px)]">
        <div
          ...
          style={{
            ...
            zIndex: 2,
            pointerEvents: 'none',
            background: spineColor ? `linear-gradient(90deg, ${spineColor} 0%, ${spineColor} 60%, transparent 100%)` : 'linear-gradient(90deg, rgba(0,0,0,0.18) 0%, rgba(0,0,0,0.08) 60%, transparent 100%)',
