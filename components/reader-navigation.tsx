  ...
  return (
    <header
      ...
      className={cn(
        ...
        scrolled
          ? "bg-emerald-500/20 dark:bg-emerald-800/95 shadow-md backdrop-blur-xl"
          : "bg-emerald-500/30 dark:bg-emerald-800/90 backdrop-blur-xl",
      )}
    >
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-1">
            {readerNavLinks.map((link, index) => {
              const isSelected =
                (link.route !== "/readers" && pathname.includes(link.route) && link.route.length > 1) ||
                pathname === link.route
                ...
                <AnimatePresence>
                  {isSearchOpen && (
                    ...
                    >
                      <Input
                        ref={searchInputRef}
                        placeholder="Поиск книг, журналов..."
          ...
          <AnimatePresence>
            {isMobileMenuOpen && (
              <motion.div
                ...
                animate="visible"
                exit="exit"
                className="absolute top-16 left-0 right-0 md:hidden py-3 border-t dark:border-gray-700 bg-white/90 dark:bg-gray-800/90 backdrop-blur-xl z-50"
              >
