...
export default function Home() {
  ...
  return <div className="min-h-screen font-[family-name:var(--font-geist-sans)] relative">
      {/* Плавающие фигуры */}
      ...
      <main className="container mx-auto px-4 py-20 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          {userRole === "Администратор" && <motion.div initial={{
          opacity: 0,
          x: 30
        }} animate={{
          opacity: 1,
      ...
      <footer className="container mx-auto px-4 py-6 backdrop-blur-xl bg-green/20 dark:bg-green/40 rounded-2xl p-4 shadow-lg transition-all duration-300 border border-white/20 dark:border-gray-700/30 relative z-10 max-w-3xl mx-auto mt-8 mb-8">
        <div className="flex flex-wrap items-center justify-center gap-6">
          <Link href="#" className="flex items-center gap-2 hover:underline hover:underline-offset-4 text-white">
            <Image aria-hidden src="/file.svg" alt="File icon" width={16} height={16} className="invert" />
            Справка
          </Link>
          <Link href="#" className="flex items-center gap-2 hover:underline hover:underline-offset-4 text-white">
            <Image aria-hidden src="/window.svg" alt="Window icon" width={16} height={16} className="invert" />
            Каталог
          </Link>
          <Link href="#" className="flex items-center gap-2 hover:underline hover:underline-offset-4 text-white">
            <Image aria-hidden src="/globe.svg" alt="Globe icon" width={16} height={16} className="invert" />
            Контакты
          </Link>
        </div>
      </footer>
