  ...
  return (
    <div className="min-h-screen relative">
      ...
      <main className="max-w-7xl mx-auto space-y-8 relative z-10 p-6">
        ...
        {isAddingRole && (
          <Section title="Добавление новой роли" delay={0.2}>
            <div className="space-y-4">
              ...
              <div className="flex gap-2 justify-end">
                <motion.button
                  ...
                  className="bg-gray-500/90 hover:bg-gray-600/90 text-white font-medium rounded-lg px-4 py-2 shadow-md backdrop-blur-md"
                >
                  Отмена
                </motion.button>
                <motion.button
                  ...
                  className="bg-emerald-500/90 hover:bg-emerald-600/90 text-white font-medium rounded-lg px-4 py-2 shadow-md backdrop-blur-md"
                >
                  Сохранить
                </motion.button>
              </div>
        ...
        {isEditingRole && editingRole && (
          <Section title="Редактирование роли" delay={0.2}>
            <div className="space-y-4">
              <div>
                <label className="block mb-1 text-white">Название</label>
                <input
        ...
        <Section title="Список ролей" delay={0.3}>
          <div className="space-y-4">
            {roles.length > 0 ? (
                    ...
                    <div className="flex justify-between items-start">
                      ...
                      <div className="flex gap-2">
                        <motion.button
                          ...
                          className="bg-emerald-500/90 hover:bg-emerald-600/90 text-white rounded-lg p-1 shadow-md backdrop-blur-md"
                        >
                        ...
                        <motion.button
                          ...
                          className="bg-red-500/90 hover:bg-red-600/90 text-white rounded-lg p-1 shadow-md backdrop-blur-md"
                        >
              ...
              <p className="text-white text-center py-4">Роли не найдены</p>
            )}
          </div>
        </Section>
      </main>
